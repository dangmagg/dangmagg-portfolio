...
export class WorkComponent implements OnInit {
  ...
  works: WorkExp[] = [
    { employer: 'Clearbridge Mobile', duration: 'Jan 2019 – Dec 2019', title: 'Android Developer, Co-op', imagelink: 'assets/logos/cbmobile-logo.jpg', 
      ...
      desc2: `Greatly improved the efficiency of a popular sports network’s video streaming mobile app by refactoring a major implementation into an external Java library, accelerating development time by 20%.`,
      ...
      desc4: `Part of the 4-member Android developer team in building and improving fitness app “ParticipACTION” for the full 4 months before their release.`,
