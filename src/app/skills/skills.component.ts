...
export class SkillsComponent implements OnInit {
  ...
  skills: Skill[] = [
    ...
    {name: 'MEAN Stack', color: this.best},
    {name: 'MongoDB', color: this.basic},
    {name: 'Angular', color: this.basic},
    {name: 'Express', color: this.basic},
    {name: 'Node', color: this.basic},
    {name: 'Flask', color: this.basic},
    {name: 'Spring', color: this.basic},
    {name: 'Dagger', color: this.basic},
    {name: 'Bootstrap', color: this.basic},
    {name: 'Material', color: this.basic},
    {name: 'PrimeNG', color: this.basic},
    {name: 'REST', color: this.basic},
    {name: 'GraphQL', color: this.basic},
    {name: 'AWS', color: this.basic},
    {name: 'Heroku', color: this.basic},
    {name: 'Firebase', color: this.basic},
